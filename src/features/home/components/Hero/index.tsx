...
export function Hero() {
  ...
  return (
    <section className="grid grid-cols-1 md:grid-cols-2">
      <div className="flex flex-col items-start justify-center gap-3 p-8 order-2 md:p-9 md:order-1">
        <h4 className="font-functional text-xs uppercase tracking-wide text-low-gray">
          Current Collection
        </h4>

        <h1 className="max-w-[450px] font-functional text-4xl leading-[0.95] text-green-default md:text-[32px]">
          A curated selection of varied products, chosen for their materials and
          finishes.
        </h1>

        <p className="max-w-[280px] text-sm leading-relaxed text-low-gray">
          A curated selection of varied products, chosen for their materials and
          finishes.
        </p>
